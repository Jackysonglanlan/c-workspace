...
// See http://howardhinnant.github.io/duration_io/chrono_io.html
...
class durationpunct : public locale::facet {
 public:
 ...
 public:
  ...
  explicit durationpunct(size_t refs = 0, int __use = use_long) : locale::facet(refs), __use_short_(__use) {}

  durationpunct(size_t refs, int __use, string_type __seconds, string_type __minutes, string_type __hours)
      : locale::facet(refs),
        __use_short_(__use),
...
template <class _CharT>
locale::id durationpunct<_CharT>::id;
...
struct __duration_manip {
  ...
  __duration_manip(bool __use_short, basic_string<_CharT> __seconds, basic_string<_CharT> __minutes,
...
template <class charT, class traits>
std::basic_ostream<charT, traits>& operator<<(std::basic_ostream<charT, traits>& os, duration_fmt d) {
  os.imbue(std::locale(os.getloc(), new durationpunct<charT>(0, d == symbol)));
  return os;
}

template <class charT, class traits>
std::basic_istream<charT, traits>& operator>>(std::basic_istream<charT, traits>& is, duration_fmt d) {
  is.imbue(std::locale(is.getloc(), new durationpunct<charT>(0, d == symbol)));
  return is;
}

template <class charT, class traits>
std::basic_ostream<charT, traits>& operator<<(std::basic_ostream<charT, traits>& os, __duration_manip<charT> m) {
  os.imbue(std::locale(os.getloc(), new durationpunct<charT>(0, m.__use_short_, std::move(m.__seconds_),
                                                             std::move(m.__minutes_), std::move(m.__hours_))));
  return os;
}

template <class charT, class traits>
std::basic_istream<charT, traits>& operator>>(std::basic_istream<charT, traits>& is, __duration_manip<charT> m) {
  is.imbue(std::locale(is.getloc(), new durationpunct<charT>(0, m.__use_short_, std::move(m.__seconds_),
                                                             std::move(m.__minutes_), std::move(m.__hours_))));
  return is;
}

inline __duration_manip<char> duration_short() {
  return __duration_manip<char>(durationpunct<char>::use_short, "", "", "");
}

template <class _CharT>
inline __duration_manip<_CharT> duration_short(basic_string<_CharT> __seconds, basic_string<_CharT> __minutes,
                                               basic_string<_CharT> __hours) {
  return __duration_manip<_CharT>(durationpunct<_CharT>::use_short, std::move(__seconds), std::move(__minutes),
                                  std::move(__hours));
}

inline __duration_manip<char> duration_long() {
  return __duration_manip<char>(durationpunct<char>::use_long, "", "", "");
}

template <class _CharT, class _T2, class _T3>
inline typename enable_if<is_convertible<_T2, basic_string<_CharT>>::value &&
                              is_convertible<_T3, basic_string<_CharT>>::value,
                          __duration_manip<_CharT>>::type
duration_long(basic_string<_CharT> __seconds, _T2 __minutes, _T3 __hours) {
  typedef basic_string<_CharT> string_type;
  return __duration_manip<_CharT>(durationpunct<_CharT>::use_long, std::move(__seconds),
                                  string_type(std::move(__minutes)), string_type(std::move(__hours)));
}
...
inline typename enable_if<is_convertible<_T2, basic_string<_CharT>>::value &&
                              is_convertible<_T3, basic_string<_CharT>>::value,
                          __duration_manip<_CharT>>::type
duration_long(const _CharT* __seconds, _T2 __minutes, _T3 __hours) {
  typedef basic_string<_CharT> string_type;
  return __duration_manip<_CharT>(durationpunct<_CharT>::use_long, string_type(__seconds),
                                  string_type(std::move(__minutes)), string_type(std::move(__hours)));
}

template <class _CharT, class _Period>
basic_string<_CharT> __get_unit(bool __is_long, const basic_string<_CharT>& __seconds, const basic_string<_CharT>&,
                                const basic_string<_CharT>&, _Period) {
  if (__is_long) {
    if (__seconds.empty()) {
  ...
  if (__seconds.empty()) return ratio_string<_Period, _CharT>::symbol() + 's';
  return ratio_string<_Period, _CharT>::symbol() + __seconds;
}

template <class _CharT>
inline basic_string<_CharT> __get_unit(bool __is_long, const basic_string<_CharT>& __seconds,
...
template <class _CharT>
basic_string<_CharT> __get_unit(bool __is_long, const basic_string<_CharT>&, const basic_string<_CharT>& __minutes,
...
template <class _CharT>
inline basic_string<_CharT> __get_unit(bool __is_long, const basic_string<_CharT>&, const basic_string<_CharT>&,
...
basic_ostream<_CharT, _Traits>& operator<<(basic_ostream<_CharT, _Traits>& __os, const duration<_Rep, _Period>& __d) {
  ...
  if (ok) {
    ...
    try {
      ...
      string_type __unit = __get_unit(__is_long, __seconds, __minutes, __hours, typename _Period::type());
      __os << __d.count() << ' ' << __unit;
    } catch (...) {
      failed = true;
    }
    if (failed) __os.setstate(ios_base::failbit | ios_base::badbit);
  }
  return __os;
}
...
struct __duration_io_intermediate<_Rep, true> {
  typedef typename conditional<is_floating_point<_Rep>::value, long double,
                               typename conditional<is_signed<_Rep>::value, long long, unsigned long long>::type>::type
      type;
};
...
template <>
long double inline __gcd(long double x, long double y) {
  return 1;
}

template <class _CharT, class _Traits, class _Rep, class _Period>
basic_istream<_CharT, _Traits>& operator>>(basic_istream<_CharT, _Traits>& __is, duration<_Rep, _Period>& __d) {
  typedef basic_string<_CharT> string_type;
  typedef durationpunct<_CharT> _F;
    ...
    if (__i != __e && *__i == ' ')  // mandatory ' ' after value
    {
      ...
      if (__i != __e) {
        ...
        if (*__i == '[') {
          ...
          ++__i;
          const basic_string<_CharT> __units[] = {__get_unit(true, __seconds, __minutes, __hours, ratio<1>()),
                                                  __get_unit(false, __seconds, __minutes, __hours, ratio<1>())};
          ios_base::iostate __err              = ios_base::goodbit;
          const basic_string<_CharT>* __k =
              __scan_keyword(__i, __e, __units, __units + sizeof(__units) / sizeof(__units[0]),
                             use_facet<ctype<_CharT>>(__loc), __err);
          ...
          const basic_string<_CharT> __units[] = {__get_unit(true, __seconds, __minutes, __hours, atto()),
      ...
      if (__i == __e) __is.setstate(__is.eofbit);
      __is.setstate(__is.failbit);
    }
  } else
    __is.setstate(__is.failbit);
...
template <class charT>
class timepunct : public std::locale::facet {
 public:
  typedef std::basic_string<charT> string_type;
 ...
 public:
  ...
  explicit timepunct(std::size_t refs = 0, const string_type& fmt = string_type(), bool local = false)
      : std::locale::facet(refs), fmt_(fmt), local_(local) {}

#if __has_feature(cxx_rvalue_references)
  explicit timepunct(std::size_t refs, string_type&& fmt, bool local = false)
      : std::locale::facet(refs), fmt_(std::move(fmt)), local_(local) {}
#endif
...
template <class CharT>
std::locale::id timepunct<CharT>::id;
...
template <class charT, class traits>
std::basic_ostream<charT, traits>& operator<<(std::basic_ostream<charT, traits>& os, __time_manip<charT> m) {
#if __has_feature(cxx_rvalue_references)
...
template <class charT, class traits>
std::basic_istream<charT, traits>& operator>>(std::basic_istream<charT, traits>& is, __time_manip<charT> m) {
#if __has_feature(cxx_rvalue_references)
...
template <class charT>
inline __time_manip<charT> local_fmt(std::basic_string<charT> fmt) {
#if __has_feature(cxx_rvalue_references)
...
template <class charT>
inline __time_manip<charT> local_fmt(const charT* fmt) {
  return __time_manip<charT>(fmt, true);
}

inline __time_manip<char> local_fmt() { return __time_manip<char>("", true); }

template <class charT>
inline __time_manip<charT> utc_fmt(std::basic_string<charT> fmt) {
#if __has_feature(cxx_rvalue_references)
...
template <class charT>
inline __time_manip<charT> utc_fmt(const charT* fmt) {
  return __time_manip<charT>(fmt, false);
}

inline __time_manip<char> utc_fmt() { return __time_manip<char>("", false); }
...
template <class charT, class traits>
std::basic_ostream<charT, traits>& operator<<(std::basic_ostream<charT, traits>& os, __time_man m) {
  os.imbue(std::locale(os.getloc(), new timepunct<charT>(0, basic_string<charT>(), m == local)));
  return os;
}

template <class charT, class traits>
std::basic_istream<charT, traits>& operator>>(std::basic_istream<charT, traits>& is, __time_man m) {
  is.imbue(std::locale(is.getloc(), new timepunct<charT>(0, basic_string<charT>(), m == local)));
  return is;
}


inline __time_man time_fmt(int f) { return __time_man(f); }
...
basic_istream<_CharT, _Traits>& operator>>(basic_istream<_CharT, _Traits>& __is,
  ...
  if (__is.good()) {
    ...
    _I __e;
    ptrdiff_t __k =
        __scan_keyword(__i, __e, &__units, &__units + 1, use_facet<ctype<_CharT>>(__is.getloc()), __err) - &__units;
    if (__k == 1) {
...
basic_ostream<_CharT, _Traits>& operator<<(basic_ostream<_CharT, _Traits>& __os,
  ...
  if (ok) {
    ...
    try {
      ...
      tm __tm;
      if (__local) {
        if (localtime_r(&__t, &__tm) == 0) failed = true;
      } else {
        if (gmtime_r(&__t, &__tm) == 0) failed = true;
      }
      if (!failed) {
        ...
        if (pb == pe) {
          ...
          if (!failed) {
            duration<double> __d = __tp - system_clock::from_time_t(__t) + seconds(__tm.tm_sec);
            if (__d.count() < 10) __os << _CharT('0');
  ...
  if (ok) {
    ...
    try {
      ...
      if (pb == pe) {
        ...
        if (err & ios_base::failbit) goto __exit;
        typedef istreambuf_iterator<_CharT, _Traits> _I;
        double __sec;
        _CharT __c = _CharT();
        __is >> __sec;
        ...
        time_t __t;
        __t  = timegm(&__tm);
        __tp = system_clock::from_time_t(__t) + minutes(__min) + round<microseconds>(duration<double>(__sec));
      } else {
        tg.get(__is, 0, __is, err, &__tm, pb, pe);
      }
    } catch (...) {
